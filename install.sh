...
node node_modules/jspm/cli.js install 'npm:vinyl-fs-that-respects-files'
node node_modules/jspm/cli.js install 'npm:map-stream'
node node_modules/jspm/cli.js install 'npm:raw-loader'
node node_modules/jspm/cli.js install 'npm:webpack@2.2'
node node_modules/jspm/cli.js install 'npm:webpack@2.2.1'
node node_modules/jspm/cli.js install 'npm:ramda'
